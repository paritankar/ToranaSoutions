...
requestHeader['Content-Disposition'] = 'multipart/form-data'
...
multipart = {
    'createVersion': 'false', 
    'requestObj': exe_requestbody,
    'file': open('C:/Users/ParimalItankar/Downloads/DEMO-RETAIL-MS_1622222322588.tar','rb'),
}

#Trigger Import API 

export_rule_response = requests.request("POST", api_base_url,  headers=requestHeader,  files=multipart ,allow_redirects=True)

if '202' in str(export_rule_response):
